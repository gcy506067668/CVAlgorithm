import argparse, os
import sys
from cvInpaint.deep_flow_guide_inpaint.dataset.data_list import gen_flow_initial_test_mask_list, \
    gen_flow_refine_test_mask_list, gen_flow_refine_test_mask_list, gen_flow_refine_test_mask_list
from cvInpaint.deep_flow_guide_inpaint.tools.infer_flownet2 import infer
from cvInpaint.deep_flow_guide_inpaint.tools.propagation_inpaint import propagation
from cvInpaint.deep_flow_guide_inpaint.tools.test_scripts import test_initial_stage, test_refine_stage

sys.path.append(os.path.abspath(os.path.join(__file__, '..', '..')))
import cvbase as cvb

from cvInpaint.deep_flow_guide_inpaint.tools.frame_inpaint import DeepFillv1
